...
asn_TYPE_member_t asn_MBR_NRPPA_PRSMuting_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NRPPA_PRSMuting, pRSMutingOption1),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NRPPA_PRSMuting, pRSMutingOption2),
	...
	{ ATF_POINTER, 1, offsetof(struct NRPPA_PRSMuting, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NRPPA_ProtocolExtensionContainer_2816P39,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_NRPPA_PRSMuting_oms_1[] = { 2 };
