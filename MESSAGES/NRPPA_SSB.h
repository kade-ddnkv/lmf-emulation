...
#ifndef	_NRPPA_SSB_H_
#define	_NRPPA_SSB_H_
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_NRPPA_SSB;
extern asn_SEQUENCE_specifics_t asn_SPC_NRPPA_SSB_specs_1;
extern asn_TYPE_member_t asn_MBR_NRPPA_SSB_1[3];
